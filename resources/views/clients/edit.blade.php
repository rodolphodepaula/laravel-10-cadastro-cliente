                  ...
                  <form action="{{ route('client.update', $client->id) }}" method="post">
                    ...
                    <fieldset class="border-2 rounded p-6">
                        ...
                        <div class="bg-gray-100 p-4 rounded overflow-hidden mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ $client->name }}" class="w-full rounded" required autofocus>
                        </div>

                        <div class="bg-gray-100 p-4 rounded overflow-hidden mb-4">
                            <label for="email">E-mail</label>
                            <input type="email" name="email" id="email" value="{{ $client->email }}" class="w-full rounded" required>
                        </div>

                        <div class="bg-gray-100 p-4 rounded overflow-hidden mb-4">
                            <label for="phone">Telefone</label>
                            <input type="tel" name="phone" id="phone" value="{{ $client->phone }}" class="w-full rounded" required>
                        </div>

                        <div class="bg-gray-100 p-4 rounded overflow-hidden mb-4">
                            <label for="company">Empresa</label>
                            <input type="text" name="company" id="company" value="{{ $client->company }}" class="w-full rounded" required>
                        </div>

                        <div class="bg-gray-100 p-4 rounded overflow-hidden mb-4">
                            <label for="company_phone">Telefone Empresa</label>
                            <input type="tel" name="company_phone" id="company_phone" value="{{ $client->company_phone }}" class="w-full rounded" required>
                        </div>
